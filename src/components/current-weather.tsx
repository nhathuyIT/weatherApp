        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center gap-2">
              <p className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tighter">
                {formatTemp(temp)}
              </p>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="space-y-0.5">
                  <p className="text-xs sm:text-sm font-medium">Wind Speed</p>
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    {speed} m/s
                  </p>
                </div>
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="relative flex aspect-square w-full max-w-[150px] sm:max-w-[200px] items-center justify-center">
              <img
